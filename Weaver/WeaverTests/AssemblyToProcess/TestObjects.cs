...
namespace AssemblyToProcess
{
    ...
    public class AllTypesObject : RealmObject
    {
        ...
        public RealmInteger<float> FloatCounterProperty { get; set; }

        public RealmInteger<double> DoubleCounterProperty { get; set; }
        ...
        public RealmInteger<float>? NullableFloatCounterProperty { get; set; }

        public RealmInteger<double>? NullableDoubleCounterProperty { get; set; }
    }
